...
func (x *GetValueReply) GetValue() int64 {
	if x != nil {
		return x.Value
	}
	return 0
...
type SetValueRequest struct {
	...
	KeyValue string `protobuf:"bytes,1,opt,name=keyValue,proto3" json:"keyValue,omitempty"`
}

func (x *SetValueRequest) Reset() {
	*x = SetValueRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_raft_rpc_raft_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetValueRequest) Descriptor() ([]byte, []int) {
	return file_raft_rpc_raft_proto_rawDescGZIP(), []int{7}
}

func (x *SetValueRequest) GetKeyValue() string {
	if x != nil {
		return x.KeyValue
	}
	return ""
...
func (x *SetValueReply) Reset() {
	*x = SetValueReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_raft_rpc_raft_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetValueReply) Descriptor() ([]byte, []int) {
	return file_raft_rpc_raft_proto_rawDescGZIP(), []int{8}
}

func (x *SetValueReply) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_raft_rpc_raft_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x65, 0x64, 0x22, 0x23, 0x0a, 0x0f, 0x47, 0x65, 0x74,
	...
	0x0a, 0x0d, 0x47, 0x65, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12,
	...
	0x2d, 0x0a, 0x0f, 0x53, 0x65, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x6b, 0x65, 0x79, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6b, 0x65, 0x79, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x29,
	0x0a, 0x0d, 0x53, 0x65, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12,
	0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0x91, 0x02, 0x0a, 0x0b, 0x52, 0x61,
	...
	,
...
var file_raft_rpc_raft_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_raft_rpc_raft_proto_goTypes = []interface{}{
	...
	(*GetValueRequest)(nil), // 5: raft_rpc.GetValueRequest
	(*GetValueReply)(nil),   // 6: raft_rpc.GetValueReply
	(*SetValueRequest)(nil), // 7: raft_rpc.SetValueRequest
	(*SetValueReply)(nil),   // 8: raft_rpc.SetValueReply
}
var file_raft_rpc_raft_proto_depIdxs = []int32{
	...
	5, // 3: raft_rpc.RaftService.GetValue:input_type -> raft_rpc.GetValueRequest
	7, // 4: raft_rpc.RaftService.SetValue:input_type -> raft_rpc.SetValueRequest
	2, // 5: raft_rpc.RaftService.AppendEntries:output_type -> raft_rpc.AppendReply
	4, // 6: raft_rpc.RaftService.RequestVote:output_type -> raft_rpc.VoteReply
	6, // 7: raft_rpc.RaftService.GetValue:output_type -> raft_rpc.GetValueReply
	8, // 8: raft_rpc.RaftService.SetValue:output_type -> raft_rpc.SetValueReply
...
func file_raft_rpc_raft_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_raft_rpc_raft_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_raft_rpc_raft_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
